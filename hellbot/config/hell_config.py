...
class Config(object):
    ...
    MY_CHANNEL = os.environ.get("YOUR_CHANNEL", "-1001445515821")
    MY_GROUP = os.environ.get("YOUR_GROUP", "-1001630503079")
    ...
    UPSTREAM_REPO = os.environ.get("UPSTREAM_REPO", "https://github.com/docugs/hellPlugins")
    WEATHER_API = os.environ.get("WEATHER_API", None)

    # APP_ID = 19866092 
    # API_HASH = "c9bb1c69cd2e96421455044819b469f2" 
    # BOT_TOKEN = "5482420002:AAG00CJLA1hOztxb0OP3C5_71jlICz3ZZso"  
    # DB_URI = "postgresql://postgres:2zOs9QUzatcqUcefLWrL@containers-us-west-62.railway.app:7201/railway"  # A postgresql database url from elephantsql
    # STRING_SESSION = "1BVtsOJ0Bu6pvFM-fH5K0-5xGEhjEHFrmByc193ee1vTjOK-biHQnJZe0MwLVwXF03H8XD1_l-2Pih7aWvS1_gurTamcH68shqj0D9mT-XTVte0Agl6mh5kiDRgNplF1UwpNp43c2Kk5DkR1oaQSJmllQ3KIHl5aaXSbHckiG_GiB2MwjcdRu0ed44HOc_Kmr6jraUd6xA6dWAOKYMqM9ewHJYIeXwUjbFeqBDDz7pedAUowMhkOY0CH3VfnljZhwfCBRGvCHtrlxqLm0ukGWAOVtDKkOrN86LIiN4dsP2WMxfEKEJbITEjvYSHpTNGCZYOLkPcbnvMjb5wFqwYSAp49aYRaOjsM="
    # HANDLER = "."  
    # SUDO_HANDLER = "!" 
