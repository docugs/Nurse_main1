...
from hellbot.utils.decorators import command
...
def load_module(shortname):
    if shortname.startswith("__"):
        ...
        LOGS.info("⚡ Alexa ⚡ - Successfully Imported " + shortname)
...
async def plug_channel(client, channel):
    if channel:
        LOGS.info("⚡ Alexa ⚡ - PLUGIN CHANNEL DETECTED.")
        LOGS.info("⚡ Alexa ⚡ - Starting to load extra plugins.")
