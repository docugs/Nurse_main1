...
if Config.BOT_USERNAME is not None and tgbot is not None:
    ...
    async def inline_handler(event):
        ...
        if event.query.user_id in auth and query == "Alexa_help":
            rev_text = query[::-1]
            ...
            result = builder.article(
                ...
                buttons=[
                    [Button.url("📑 Repo 📑", "https://github.com/docugs/hellPlugins")],
            ...
            result = builder.article(
                "@YMMLLL",
                text="""**Hey! This is [Alexa](https://t.me/YMMLLL) \nYou can know more about me from the links given below 👇**""",
                buttons=[
                    [
                        custom.Button.url("🔥 CHANNEL 🔥", "https://t.me/YMMLLL"),
                        custom.Button.url("⚡ GROUP ⚡", "https://t.me/hellbot_chat"),
                    ],
                    [
                        custom.Button.url("✨ REPO ✨", "https://github.com/docugs/hellPlugins"),
    ...
    async def on_pm_click(event):
        ...
        if event.query.user_id in auth:
            ...
            reply_pop_up_alert = "🔰 This is Alexa PM Security to keep away unwanted retards from spamming PM !!"
    ...
    async def on_plug_in_callback_query_handler(event):
        ...
        if event.query.user_id in auth:
            ...
            await event.edit(f"**⚜️ Alexa Mêñû Prõvîdêr ìs ñôw Çlösëd ⚜️**\n\n**Bot Of :**  {hell_mention}\n\n        [©️ Alexa ™️]({chnl_link})", buttons=veriler, link_preview=False)
        else:
            reply_pop_up_alert = "You are not authorized to use me! \n© Alexa ™"
            await event.answer(reply_pop_up_alert, cache_time=0, alert=True)
